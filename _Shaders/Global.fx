cbuffer CB_PerFrame
{
    ...
    matrix Projection; // View 행렬의 역행렬은 변환하기 전 결과가 할당
    matrix VP;
...
TextureCube SkyCubeMap; // 쉐이더를 통합 예정
...
RasterizerState FrontCounterClockwise_True // 반시계방향으로 랜더링
{
    FrontCounterClockwise = true;
};

RasterizerState FillMode_WireFrame // 정점을 이으고 있는 선으로만 랜더링
{
    FillMode = WireFrame;
};

DepthStencilState DepthEnable_False // 랜더링 순서를 위한 깊이
{
    DepthEnable = false;
};
